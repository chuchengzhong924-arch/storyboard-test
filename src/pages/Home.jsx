...
export default function Home() {
  return (
    <main className="site-home">
      <section className="home-hero" aria-labelledby="company-title">
        <div>
      ...
      <section className="home-section" aria-labelledby="category-title">
        ...
        <div className="category-grid">
          <Link className="category-card ai" to="/ai-film"><small>01 / Production</small><h3>AI电影制作</h3><p>从概念设定、剧本拆解到分镜预演，快速形成可沟通、可拍摄、可迭代的电影项目方案。</p><span>查看项目</span></Link>
          <Link className="category-card company" to="/about"><small>02 / Company</small><h3>公司介绍</h3><p>以 AI 影像技术连接导演、编剧、美术、剪辑和制片管理，建立新一代影视生产管线。</p><span>查看详情</span></Link>
          <Link className="category-card partners" to="/cases"><small>03 / Cases</small><h3>作品案例</h3><p>以《文天祥：丹心照汗青》为代表，展示历史先导片的镜头设计、视觉节奏与情绪推进。</p><span>查看案例</span></Link>
          <Link className="category-card founder" to="/contact"><small>04 / Contact</small><h3>联系我们</h3><p>面向影视机构、文旅品牌、科技企业与海外发行伙伴，提供联合开发和项目制片协作。</p><span>联系合作</span></Link>
        </div>
      </section>
